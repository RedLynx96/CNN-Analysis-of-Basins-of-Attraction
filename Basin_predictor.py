...
class Basin_Metrics_GUI:
    ...
    def open_csv(self):
        ...
        self.Basins_Characterized_df.Name = Basins_df['Name']
        ...
        for i in range(0,len(Basins_df)):
            ...
            mat_contents = sp.loadmat(Basins_df['Basin'][i])
    ...
    def Load_CNN(self):
        self.CNN_path = 'models/'
        self.CNN_architecture = 'ResNet50'
        
        self.Basin_metrics = ['FDim','Sb','Sbb','Wada']
        self.optimizer = Adam(learning_rate=1e-3, beta_1=0.9, beta_2=0.999, epsilon=1e-8, amsgrad=True)
        ...
        for i in self.Basin_metrics:
            if i != 'Wada':
                ...
                model.load_weights(self.CNN_path + self.CNN_architecture + '_' + i + '_model.hdf5')
            else:
    ...
    def compute_Metrics(self):
        ...
        self.Basins_Characterized_df.to_csv('results/Basins_Characterized.csv', index=False) 
    ...
    def Load_Table(self):
        ...
        pt.show()
        #self.Basins_Characterized_df.FDim
